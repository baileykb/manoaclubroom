        ...
        <div className='landing-background'>
          <Grid stackable centered container columns={3}>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h3' color='green'>Search for specific clubs that you may have heard about. If you do not have
                a
              ...
              <Grid.Column textAlign='center'>
                ...
                <Header as='h3' color='green'>Descriptions of the club are shown to give interested students an overview
                  of
