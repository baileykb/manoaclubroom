...
class Request extends React.Component {
  ...
  onClick() {
    Clubs.insert(this.props.request.name, this.props.request.location, this.props.request.time, this.props.request.interest, this.props.request.image, this.props.request.description);
  }
